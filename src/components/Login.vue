    ...
    <div class="login_box">
      ...
      <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
        ...
        <el-form-item prop="username">
          <el-input v-model="loginForm.username" prefix-icon="iconfont icon-user" placeholder="用户名3-10位"></el-input>
        </el-form-item>
        <!-- 密码 -->
        <el-form-item prop="password">
          <el-input v-model="loginForm.password" prefix-icon="iconfont icon-3702mima" type="password"
                    placeholder="密码6-15位"></el-input>
        </el-form-item>
        <!-- 按钮 -->
        <el-form-item class="btns">
          <el-button type="success" plain @click="login">登录</el-button>
          <el-button type="success" plain v-on:click="resetLoginForm">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  methods: {
    ...
    login () {
      this.$refs.loginFormRef.validate(async valid => {
        ...
        //   项目中除了登录之外的 API 接口，必须在登录成功之后才能访问
